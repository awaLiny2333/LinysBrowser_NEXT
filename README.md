...
fix：修复更新，用于标注对一个问题的修复；
feat：功能更新，一般用于标注推出了什么新功能；
improve：改进更新，一般用于标注已有的某些东西的变化，如逻辑、界面、文案等；
code：代码更新，用于标注代码优化，如代码整理、逻辑整理等；
version：版本号变更，用于标注版本号的变化；
api：API 级别变更，用于标注需要的 API 级别的变化。